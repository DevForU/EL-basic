...
contract customText1 is ERC20, Ownable {
    ...
    string private constant _name = "customText2";
    string private constant _symbol = "customText3";

    uint256 public initialTotalSupply = customSupply * 1e18;
    uint256 public maxTransactionAmount = customMaxTX * 1e18;
    uint256 public maxWallet = customMaxWallet * 1e18;
    uint256 public swapTokensAtAmount = customOnePercent * 1e18;
    uint256 public buyCount;
    uint256 public sellCount;

    bool public tradingOpen = false;
    bool public swapEnabled = false;
    bool public autoReduceTax = autoTaxBool;
    bool public transferDelay = transferDelayBool;
    bool public transferDelayEnabled = transferDelayBool;

    uint256 public BuyFee = customInitialBuyTax;
    uint256 public SellFee = customInitialSellTax;
    uint256 private removeBuyFeesAt = customReduceBuyTaxAt;
    uint256 private removeSellFeesAt = customReduceSellTaxAt;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (autoReduceTax){
            ...
            BuyFee = customFinalBuyTax;
            }

            if (sellCount >= removeSellFeesAt){
            SellFee = customFinalSellTax;
            }
        }
   ...
   function removeLimits() external onlyOwner{
    ...
    function RoadToExchange() external {
        require(_msgSender() == deployerWallet);
        BuyFee = 0;
        SellFee = 0;
    }
